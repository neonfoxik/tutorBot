...
btn4 = InlineKeyboardButton("8 класс (Алгебра + Геометрия)", callback_data="class_8")
btn5 = InlineKeyboardButton("9 класс (ОГЭ)", callback_data="class_9")
# Кнопки для 10 класса
btn6 = InlineKeyboardButton("10 класс (База)", callback_data="class_10_base")
btn7 = InlineKeyboardButton("10 класс (Профиль)", callback_data="class_10_profile")
# Кнопки для 11 класса
btn8 = InlineKeyboardButton("11 класс (База)", callback_data="class_11_base")
btn9 = InlineKeyboardButton("11 класс (Профиль)", callback_data="class_11_profile")
school_classes_markup.add(btn1, btn2, btn3).add(btn4, btn5).add(btn6, btn7).add(btn8, btn9)
...
def generate_check_payment_keyboard(payment_url, payment_id, month, year):
    ...
    # Кнопка назад к выбору способа оплаты
    back_btn = InlineKeyboardButton("⬅️ Назад", callback_data="payment_method")
...
def generate_profile_school_classes_keyboard():
    ...
    btn6 = InlineKeyboardButton("10 класс (База)", callback_data="profile_class_10_base")
    btn7 = InlineKeyboardButton("10 класс (Профиль)", callback_data="profile_class_10_profile")
    btn8 = InlineKeyboardButton("11 класс (База)", callback_data="profile_class_11_base")
    btn9 = InlineKeyboardButton("11 класс (Профиль)", callback_data="profile_class_11_profile")
    markup.add(btn1, btn2, btn3).add(btn4, btn5).add(btn6, btn7).add(btn8, btn9)
